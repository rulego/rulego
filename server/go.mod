...
require (
	...
	github.com/cloudwego/eino-ext/components/tool/duckduckgo/v2 v2.0.0-20260722085247-fcd0353d606c // indirect
	...
	github.com/rulego/streamsql v1.1.2 // indirect
...
// Use the local version of the component package during local development
