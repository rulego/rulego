...
func (x *Mqtt) Init(ruleConfig types.Config, configuration types.Configuration) error {
	...
	_ = x.NetNode.Init(x.RuleConfig, x.Type(), x.Config.Server, true, func() (*mqtt.Client, error) {
		return x.initClient()
	})
	return err
}
...
func (x *Mqtt) RemoveRouter(routerId string, params ...interface{}) error {
	...
	if router != nil {
		client, _ := x.NetNode.GetResource()
		if client != nil {
...
func (x *Mqtt) GetNetResource() (interface{}, error) {
